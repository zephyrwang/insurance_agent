...
def get_engine(db_url: str = None):
    ...
    url = db_url or os.getenv(
        "DATABASE_URL", "sqlite:///./insurance_dev.db"  # fallback for local dev
    )
